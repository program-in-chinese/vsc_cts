...
class TypeScriptServiceConfiguration {
    ...
    static readTsServerLogLevel(configuration) {
        const setting = configuration.get('ctsscript.tsserver.log', 'off');
        return TsServerLogLevel.fromString(setting);
    }
    static readNpmLocation(configuration) {
        return configuration.get('ctsscript.npm', null);
    }
    static readDisableAutomaticTypeAcquisition(configuration) {
        return configuration.get('ctsscript.disableAutomaticTypeAcquisition', false);
    }
    static extractLocale(configuration) {
        return configuration.get('ctsscript.locale', null);
    }
}
